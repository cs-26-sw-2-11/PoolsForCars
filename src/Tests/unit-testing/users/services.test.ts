...
describe("", () => {
    ...
    describe("Login Service", () => {
        ...
        ("returns $expected for $label", async ({ mockUser, body, expected, lever }) => {
            vi.mocked(userModel.readUsersJSON).mockResolvedValue(mockUser as userModel.usersJSON);
...
describe("", () => {
    ...
    describe("doSignup", () => {
        ...
        it("creates a new user when they do not exist", async () => {
            ...
            // Act
            await uservices.doSignup(req as string, req as string,req as string,req as huservices.userPreferences);
        ...
        it("throws when the user already exists", async () => {
            ...
            // Act
            const result = await uservices.doSignup(req as string, req as string,req as string,req as huservices.userPreferences);
        ...
        it("propagates errors from createUser", async () => {
            ...
            await expect(uservices.doSignup(req as string, req as string,req as string,req as huservices.userPreferences)).rejects.toThrow("DB failure");
        })
    })
})
...
describe("updateUserInfoById",() => {
    ...
    it("updates an existing user with matching information", async () => {
        ...
        // Act
        const result = await uservices.updateUserInfoById(firstName, lastName, phoneNumber, lookingForGroups, userId);
