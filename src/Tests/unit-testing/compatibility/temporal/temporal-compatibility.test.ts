...
import { Calendar, dateToWeek, getFirstDayOfWeek, getLastWorkdayOfWeek, weekToDate } from '../../../../models/calendar.model'
...
const weekStartDate: Date = await getFirstDayOfWeek(await weekToDate(weekNumber));
const weekEndDate: Date = await getLastWorkdayOfWeek(await weekToDate(weekNumber));
const weekDates = [
    weekStartDate,
...
const newMockUser = (id: number, firstName: string, lastName: string, address: string, TOAs: string[], driver: boolean) => {
...
describe('Find Eligble Drivers', () => {
    ...
    test('Basic test. 4 Drivers, 1 Passenger With The Same TOAs', async () => {
        expect(await findEligbleDrivers(mockUsers.get(4) as User, mockUsers)).toStrictEqual(
            {
                "weeks": {
                    "22": {
                        "Monday": {
    ...
    test('"Random" TOAs', async () => {
        mockUsers.set(0, newMockUser(0, "User", "Zero", "Stendyssen 123, Svenstrup, ND, Denmark",
            [
                "08:30",
                "08:00",
                "09:00",
        ...
        mockUsers.set(1, newMockUser(1, "User", "One", "Duathlonstien, Svenstrup, ND, Denmark",
            [
                "08:35",
                "08:30",
                "09:00",
        ...
        mockUsers.set(2, newMockUser(2, "User", "Two", "Hobrovej, Aalborg, ND, Denmark",
            [
                "09:00",
                "08:50",
                "08:55",
        ...
        mockUsers.set(3, newMockUser(3, "User", "Three", "Over Kæret, Aalborg, ND, Denmark",
            [
                "08:55",
                "09:00",
                "08:45",
        ...
        mockUsers.set(4, newMockUser(4, "User", "Four", "Universitetskorridoren, Aalborg, ND, Denmark",
            [
                "09:00",
                "09:00",
                "09:00",
        ...
        const result = await findEligbleDrivers(mockUsers.get(4) as User, mockUsers);
        ...
        expect(result.accumulator[2]).toBeCloseTo(1 + 2 / 3 + 5 / 6 + 1 / 6 + 1 / 2, 8);
